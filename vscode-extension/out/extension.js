...
async function initializeMCPClient(context) {
    try {
        ...
        const serverProcess = (0, child_process_1.spawn)('npx', ['tsx', mcpServerPath], {
...
async function activate(context) {
    ...
    const participant = vscode.chat.createChatParticipant('douglas-digital-twin.douglas', chatRequestHandler);
